...
* [Jenkins Build-Bot (Last releases can be found here)](http://ci.maescool.be/)
* [Download last release](http://ci.maescool.be/job/Catacomb-Snatch/lastSuccessfulBuild/artifact/build/libs/Catacomb-Snatch-1.0.0-BETA.jar)
* [Download last development build](http://ci.maescool.be/job/Catacomb-Snatch-Dev/lastSuccessfulBuild/artifact/build/libs/Catacomb-Snatch-1.1.0-SNAPSHOT.jar)
