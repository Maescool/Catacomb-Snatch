...
* [Website and forum](http://catacombsnatch.info/)
...
* Chat with the developers on the [Webchat](http://webchat.freenode.net/catacomb-snatch) or irc.freenode.net #catacomb-snatch