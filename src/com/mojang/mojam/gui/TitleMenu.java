...
public class TitleMenu extends GuiMenu {
	...
	public static final int KEY_FIRE_ID = 3001;
	public static final int KEY_BUILD_ID = 3002;
	public static final int KEY_USE_ID = 3003;
	public static final int KEY_UP_ID = 3004;
	public static final int KEY_DOWN_ID = 3005;
	public static final int KEY_LEFT_ID = 3006;
	public static final int KEY_RIGHT_ID = 3007;
	public static final int KEY_UPGRADE_ID = 3008;
	public static final int KEY_SPRINT_ID = 3009;
