...
public class CharacterSelectMenu extends GuiMenu {
	...
	private void addButtons() {
		...
		selected = (CharacterButton) addButton(new CharacterButton(TitleMenu.CHARACTER_BUTTON_ID,
				Art.CHARACTER_LORD_LARD, Art.getPlayerArt(Art.CHARACTER_LORD_LARD)[0][6], xOffset,
				yOffset));
		selected.setSelected(true);
		addButton(new CharacterButton(TitleMenu.CHARACTER_BUTTON_ID, Art.CHARACTER_HERR_SPECK,
				Art.getPlayerArt(Art.CHARACTER_HERR_SPECK)[0][2], xOffset + 20
						+ CharacterButton.WIDTH, yOffset));
		addButton(new CharacterButton(TitleMenu.CHARACTER_BUTTON_ID, Art.CHARACTER_DUCHESS_DONUT,
				Art.getPlayerArt(Art.CHARACTER_DUCHESS_DONUT)[0][6], xOffset, yOffset + 20
						+ CharacterButton.HEIGHT));
		addButton(new CharacterButton(TitleMenu.CHARACTER_BUTTON_ID,
				Art.CHARACTER_COUNTESS_CRULLER,
				Art.getPlayerArt(Art.CHARACTER_COUNTESS_CRULLER)[0][2], xOffset + 20
						+ CharacterButton.WIDTH, yOffset + 20 + CharacterButton.HEIGHT));
	...
	public void render(Screen screen) {
		...
		super.render(screen);
		Font.drawCentered(screen, MojamComponent.texts.getStatic("character.text"),
