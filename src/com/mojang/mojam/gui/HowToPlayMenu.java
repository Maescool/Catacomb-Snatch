...
<<<<<<< HEAD
	...
	private void printHelpText(Screen screen) {
		Font.drawCentered(screen, MojamComponent.texts.getStatic("help.goal")
				+ ":", goalX, goalTopMargin);
		Font.drawCentered(screen, MojamComponent.texts.getStatic("help.help1"),
				goalX, goalTopMargin + 10);
		Font.drawCentered(screen, MojamComponent.texts.getStatic("help.help2"),
				goalX, goalTopMargin + 20);
		Font.drawCentered(screen, MojamComponent.texts.getStatic("help.help3"),
				goalX, goalTopMargin + 30);
...
>>>>>>> parent of cd61150... Cleanups, JavaDoc updates and some minor refactoring
		...
		Font.draw(screen, MojamComponent.texts.getStatic("help.turret"), tab1,
				line);
		screen.blit(Art.pickupCoinGold[0][0], tab1, line + 10);
		Font.draw(screen, "150", tab1 + 20, line + 15);
		Font.draw(screen, MojamComponent.texts.getStatic("help.turret1"), tab2,
				line);
		Font.draw(screen, MojamComponent.texts.getStatic("help.turret2"), tab2,
				line + 10);
		Font.draw(screen, MojamComponent.texts.getStatic("help.turret3"), tab2,
				line + 20);
		...
		Font.draw(screen, MojamComponent.texts.getStatic("help.collector"),
				tab1, line);
		screen.blit(Art.pickupCoinGold[0][0], tab1, line + 10);
		Font.draw(screen, "300", tab1 + 20, line + 15);
		Font.draw(screen, MojamComponent.texts.getStatic("help.collector1"),
				tab2, line);
		Font.draw(screen, MojamComponent.texts.getStatic("help.collector2"),
				tab2, line + 10);
		Font.draw(screen, MojamComponent.texts.getStatic("help.collector3"),
				tab2, line + 20);

		// Bomb
		line += vspace;
		screen.blit(Art.bomb, imgTab, line);
		Font.draw(screen, MojamComponent.texts.getStatic("help.bomb"), tab1,
				line);
		screen.blit(Art.pickupCoinGold[0][0], tab1, line + 10);
		Font.draw(screen, "500", tab1 + 20, line + 15);
		Font.draw(screen, MojamComponent.texts.getStatic("help.bomb1"), tab2,
				line);
		Font.draw(screen, MojamComponent.texts.getStatic("help.bomb2"), tab2,
				line + 10);
		Font.draw(screen, MojamComponent.texts.getStatic("help.bomb3"), tab2,
				line + 20);

		line += vspace;
		screen.blit(Art.rails[1][0], imgTab, line);
		Font.draw(screen, MojamComponent.texts.getStatic("help.rails"), tab1,
				line);
		screen.blit(Art.pickupCoinGold[0][0], tab1, line + 10);
		Font.draw(screen, "10 (+)", tab1 + 20, line + 15);
		Font.draw(screen, "15 (-)", tab1 + 20, line + 25);
		Font.draw(screen, MojamComponent.texts.getStatic("help.rails1"), tab2,
				line);
		Font.draw(screen, MojamComponent.texts.getStatic("help.rails2"), tab2,
				line + 10);
		Font.draw(screen, MojamComponent.texts.getStatic("help.rails3"), tab2,
				line + 20);
