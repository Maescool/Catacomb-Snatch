...
public class LevelSelect extends GuiMenu {
	...
	private void updateLevelButtons(AbstractScreen screen) {
		int y = 0;
		...
		for (int i = currentPage * LEVELS_PER_PAGE;
			...
			levelButtons[buttonIndex] = (LevelButton) addButton(new LevelButton(i, screen, levels.get(i),
