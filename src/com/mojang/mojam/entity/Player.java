...
public class Player extends Mob implements LootCollector {
	...
	public void render(AbstractScreen screen) {
		...
		if (muzzleTicks > 0 && behind) {
			screen.blit(Art.muzzle[muzzleImage][0], (int) xmuzzle, (int) ymuzzle);
		}

		if (hurtTime % 2 != 0) {
			screen.colorBlit(sheet[frame][facing], (int) (pos.x - Tile.WIDTH / 2), (int) (pos.y - Tile.HEIGHT / 2 - 8), 0x80ff0000);
		} else if (flashTime > 0) {
			screen.colorBlit(sheet[frame][facing], (int) (pos.x - Tile.WIDTH / 2), (int) (pos.y - Tile.HEIGHT / 2 - 8), 0x80ffff80);
		} else {
			screen.blit(sheet[frame][facing], (int) (pos.x - Tile.WIDTH / 2), (int) (pos.y - Tile.HEIGHT / 2 - 8));
		}
	...
	private void addSprintBar(AbstractScreen screen) {
		...
		screen.blit(Art.sprintBar[start][0], (int) (pos.x - 16), (int) (pos.y + 8));
	}
