...
public class PlayerFallingAnimation extends Animation {
    ...
    public void render(AbstractScreen screen) {
        ...
        screen.blit(Art.getPlayer(character)[0][anim%8 + 8], (int)pos.x,(int)(pos.y + Tile.HEIGHT - anim*3));
        screen.blit(Art.exclamation_mark,(int)(pos.x + 20),(int)(pos.y + Tile.HEIGHT - anim*3 - 5));
