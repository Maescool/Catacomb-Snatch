...
public class RailDroid extends Mob {
	...
	protected boolean shouldBlock(Entity e) {
		...
		if (e instanceof Bullet && ((Bullet) e).owner instanceof Turret && ((Bullet) e).owner.team == team) {
			return false;
		}
	...
	public void render(AbstractScreen screen) {
		super.render(screen);
		if (carrying) {
			screen.blit(Art.bullets[0][0], (int) (pos.x - 8), (int) (pos.y - 20 - yOffs));
		} else {
			screen.blit(Art.bullets[1][1], (int) (pos.x - 8), (int) (pos.y - 20 - yOffs));
		}
	}
}
