...
public abstract class Mob extends Entity {
	...
	public void render(AbstractScreen screen) {
		...
		if (hurtTime > 0) {
			if (hurtTime > 40 - 6 && hurtTime / 2 % 2 == 0) {
				screen.colorBlit(image, (int) (pos.x - image.getWidth() / 2), (int) (pos.y - image.getHeight() / 2 - yOffs), 0xa0ffffff);
			} else {
				if (health < 0) {
					health = 0;
				}
				...
				screen.colorBlit(image, (int) (pos.x - image.getWidth() / 2), (int) (pos.y - image.getHeight() / 2 - yOffs), (col << 24) + 255 * 65536);
			}
		} else {
			screen.blit(image, (int) (pos.x - image.getWidth() / 2), (int) (pos.y - image.getHeight() / 2 - yOffs));
		}
	...
	protected void addHealthBar(AbstractScreen screen) {
		...
		screen.blit(Art.healthBar_Underlay[0][0], (int) (pos.x - 16), (int) (pos.y + healthBarOffset));
		screen.colorBlit(Art.healthBar[start][0], (int) (pos.x - 16), (int) (pos.y + healthBarOffset), (0xff << 24) + color);
		screen.blit(Art.healthBar_Outline[0][0], (int) (pos.x - 16), (int) (pos.y + healthBarOffset));
	}
