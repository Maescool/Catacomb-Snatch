...
public class Loot extends Entity {
	...
	public void render(AbstractScreen screen) {
		...
		if (life > 60 * 3 || life / 2 % 2 == 0) {
			...
			if (accelerationDirection > 0) {
				screen.blit(Art.shadow, (int) pos.x - 2, (int) pos.y);
			}
			screen.blit(currentFrame, (int) (pos.x - currentFrame.getWidth() / 2), (int) (pos.y - currentFrame.getHeight() / 2 - 2 - accelerationDirection));
		}
	}
