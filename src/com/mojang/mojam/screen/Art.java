...
public class Art {
	...
	public static Bitmap[][] wallTiles = cut("/art/map/floortiles.png", 32, 56,
			0, 104);
	public static int[][] wallTileColors = getColors(wallTiles);
	public static Bitmap[][] treasureTiles = cut("/art/map/treasure.png", 32,
			56);
	...
	public static Bitmap[][] lordLard = cut("/art/player/lord_lard_sheet.png",
			32, 32);
	public static Bitmap[][] herrSpeck = cut(
			"/art/player/herr_von_speck_sheet.png", 32, 32);
	public static Bitmap[][] startLordLard = cut(
			"/art/player/start_lordlard.png", 32, 32);
	public static Bitmap[][] startHerrSpeck = cut(
			"/art/player/start_herrspeck.png", 32, 32);

	public static Bitmap[][] duchessDonut = cut(
			"/art/player/duchess_donut_sheet.png", 32, 32);
	...
	public static Bitmap[][] harvester = cut("/art/building/bot_vacuum.png",
			32, 56);
	public static Bitmap[][] harvester2 = cut("/art/building/bot_vacuum2.png",
			32, 56);
	public static Bitmap[][] harvester3 = cut("/art/building/bot_vacuum3.png",
			32, 56);
	...
	public static Bitmap[][] font_default = cut("/art/fonts/font_default.png",
			8, 8);
	...
	public static Bitmap[][] mummy = cut("/art/mob/enemy_mummy_anim_48.png",
			48, 48);
	public static Bitmap[][] snake = cut("/art/mob/enemy_snake_anim_48.png",
			48, 48);
	public static Bitmap[][] scarab = cut("/art/mob/enemy_scarab_anim_48.png",
			48, 48);
	...
	public static Bitmap[][] pickupCoinBronzeSmall = cut(
			"/art/pickup/pickup_coin_bronze_small_8.png", 8, 8);
	public static Bitmap[][] pickupCoinBronze = cut(
			"/art/pickup/pickup_coin_bronze_16.png", 16, 16);
	public static Bitmap[][] pickupCoinSilverSmall = cut(
			"/art/pickup/pickup_coin_silver_small_8.png", 8, 8);
	public static Bitmap[][] pickupCoinSilver = cut(
			"/art/pickup/pickup_coin_silver_16.png", 16, 16);
	public static Bitmap[][] pickupCoinGoldSmall = cut(
			"/art/pickup/pickup_coin_gold_small_8.png", 8, 8);
	public static Bitmap[][] pickupCoinGold = cut(
			"/art/pickup/pickup_coin_gold_16.png", 16, 16);
	public static Bitmap[][] pickupGemEmerald = cut(
			"/art/pickup/pickup_gem_emerald_12.png", 16, 16);
	public static Bitmap[][] pickupGemRuby = cut(
			"/art/pickup/pickup_gem_ruby_12.png", 16, 16);
	public static Bitmap[][] pickupGemDiamond = cut(
			"/art/pickup/pickup_gem_diamond_24.png", 24, 24);
	public static Bitmap[][] shineSmall = cut(
			"/art/pickup/effect_shine_small_13.png", 13, 13);
	public static Bitmap[][] shineBig = cut(
			"/art/pickup/effect_shine_big_13.png", 13, 13);
	...
	public static Bitmap[][] fxEnemyDie = cut(
			"/art/effects/fx_enemydie_64.png", 64, 64);
	public static Bitmap[][] fxSteam24 = cut("/art/effects/fx_steam1_24.png",
			24, 24);
	public static Bitmap[][] fxSteam12 = cut("/art/effects/fx_steam2_12.png",
			12, 12);
	public static Bitmap[][] fxBombSplosion = cut(
			"/art/effects/fx_bombsplosion_big_32.png", 32, 32);
	public static Bitmap[][] fxBombSplosionSmall = cut(
			"/art/effects/fx_bombsplosion_small_32.png", 32, 32);
	public static Bitmap[][] fxDust12 = cut("/art/effects/fx_dust2_12.png", 12,
			12);
	public static Bitmap[][] fxDust24 = cut("/art/effects/fx_dust1_24.png", 24,
			24);
	public static Bitmap[][] moneyBar = cut("/art/effects/bar_blue.png", 32, 4);
	public static Bitmap[][] healthBar = cut("/art/effects/bar_green.png", 32,
			4);
