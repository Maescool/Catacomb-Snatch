...
public class Art {
    ...
    public static Bitmap[][] pickupCoinSilverSmall = cut("/pickup/pickup_coin_silver_small_8.png", 8, 8);
    ...
    public static Bitmap[][] fxBombSplosionSmall = cut("/effects/fx_bombsplosion_small_32.png", 32, 32);
