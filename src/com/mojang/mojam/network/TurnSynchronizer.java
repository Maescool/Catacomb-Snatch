...
public class TurnSynchronizer {
    ...
    public TurnSynchronizer(CommandListener commandListener, PacketLink packetLink, int localId, int numPlayers) {
...
//        public void onReceivedCommands(int playerId, List<NetworkCommand> list) {
