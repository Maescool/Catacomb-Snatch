...
public class DestroyableWallTile extends WallTile {
    ...
    public void render(Screen screen) {
        screen.blit(Art.treasureTiles[4][0], x * Tile.WIDTH, y * Tile.HEIGHT - (WALLHEIGHT - Tile.HEIGHT));
    }

    public void renderTop(Screen screen) {
        screen.blit(Art.treasureTiles[4][0], x * Tile.WIDTH, y * Tile.HEIGHT - (WALLHEIGHT - Tile.HEIGHT), 32, 32);
    }
