...
public class RandomSpawner implements ILevelTickItem {
    ...
    private static final BBPredicate<Entity> playerOrSpawnerEntityNearby =
            new EntityIntersectsBBAndInstanceOf(Player.class,
                    SpawnerEntity.class);
	...
	public void tick(Level level) {
		...
		if (tile instanceof FloorTile) {
            ...
            if (level.getEntities(
                    x - r, y - r, x + r, y + r,
                    playerOrSpawnerEntityNearby).isEmpty()) {
                r = 32 * 4;
                if (level.getEntities(
                        x - r, y - r, x + r, y + r,
                        Turret.class).isEmpty()) {
