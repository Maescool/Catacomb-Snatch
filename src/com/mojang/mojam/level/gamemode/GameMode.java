...
public class GameMode {
	...
	public Level generateLevel(LevelInformation li, int localTeam, int playerCharacterID, int opponentCharacterID)  throws IOException {
		...
		newLevel = new Level(w, h, playerCharacterID, opponentCharacterID);
