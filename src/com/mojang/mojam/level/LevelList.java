...
public class LevelList {
	...
	public static void createLevelList() {
		...
		levels.add(new LevelInformation("AsymeTrical",
				"/levels/AsymeTrical.bmp", true));
		...
		levels.add(new LevelInformation("Circular_Shapes",
				"/levels/Circular Shapes.bmp", true));
		levels.add(new LevelInformation("BlackHole", "/levels/BlackHole.bmp",
				true));
		levels.add(new LevelInformation("Railroads", "/levels/RailRoads.bmp",
				true));
		...
		if (children != null) {
			for (File child : children) {
				...
				if (ext.toLowerCase().equals("bmp")) {
					levels.add(new LevelInformation("+ " + fname, child
							.getPath(), false));
				}
			}
		}
