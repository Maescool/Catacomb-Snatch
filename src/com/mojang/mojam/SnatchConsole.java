...
public class SnatchConsole implements Runnable, KeyListener
{
	...
	private SnatchConsole(JTextArea displayPane, PipedOutputStream pos)
	{
	...
	{
		SnatchConsole.redirectOut(displayPane);
		SnatchConsole.redirectErr(displayPane);
	}
	...
	public static void redirectOut(JTextArea displayPane)
	{
		...
		SnatchConsole console = new SnatchConsole(displayPane, pos);
